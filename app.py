...
def Question_mcqs_generator(input_text, num_questions):
    print("Generating MCQs with the following input text:")
    print(input_text[:500])  # Print first 500 characters for brevity
    ...
    try:
        ...
        print(mcqs[:500])  # Print first 500 characters for brevity
        return mcqs
